...
// Original file name:
// Generation date: 21.11.2023 22:00:38
namespace SEDModel
{
    
    /// <summary>
    /// There are no comments for SEDEntities in the schema.
    /// </summary>
    public partial class SEDEntities : global::System.Data.Services.Client.DataServiceContext
    {
        /// <summary>
        /// Initialize a new SEDEntities object.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")]
        public SEDEntities(global::System.Uri serviceRoot) : 
        ...
        private abstract class GeneratedEdmModel
        {
            ...
            private const string ModelPart0 = "<edmx:Edmx Version=\"1.0\" xmlns:edmx=\"http://schemas.microsoft.com/ado/2007/06/edm" +
                ...
                "Namespace=\"SEDModel\" xmlns=\"http://schemas.microsoft.com/ado/2009/11/edm\"><Entit" +
                ...
                "/schemas.microsoft.com/ado/2009/02/edm/annotation\" /><Property Name=\"student_id\"" +
                " Type=\"Edm.Int32\" Nullable=\"false\" /><Property Name=\"subject\" Type=\"Edm.String\" " +
                "Nullable=\"false\" MaxLength=\"255\" FixedLength=\"false\" Unicode=\"false\" /><Property" +
                " Name=\"note1\" Type=\"Edm.Int32\" /><NavigationProperty Name=\"Student\" Relationship" +
                "=\"SEDModel.FK__Note__student_id__38996AB5\" ToRole=\"Student\" FromRole=\"Note\" /></" +
                "EntityType><EntityType Name=\"Student\"><Key><PropertyRef Name=\"id\" /></Key><Prope" +
                ...
                "ty Name=\"name\" Type=\"Edm.String\" Nullable=\"false\" MaxLength=\"255\" FixedLength=\"f" +
                "alse\" Unicode=\"false\" /><NavigationProperty Name=\"Note\" Relationship=\"SEDModel.F" +
                "K__Note__student_id__38996AB5\" ToRole=\"Note\" FromRole=\"Student\" /></EntityType><" +
                "Association Name=\"FK__Note__student_id__38996AB5\"><End Type=\"SEDModel.Student\" R" +
                "ole=\"Student\" Multiplicity=\"1\" /><End Type=\"SEDModel.Note\" Role=\"Note\" Multiplic" +
                "ity=\"*\" /><ReferentialConstraint><Principal Role=\"Student\"><PropertyRef Name=\"id" +
                "\" /></Principal><Dependent Role=\"Note\"><PropertyRef Name=\"student_id\" /></Depend" +
                "ent></ReferentialConstraint></Association></Schema><Schema Namespace=\"MVC.Edmx\" " +
                "xmlns=\"http://schemas.microsoft.com/ado/2009/11/edm\"><EntityContainer Name=\"SEDE" +
                "ntities\" m:IsDefaultEntityContainer=\"true\"><EntitySet Name=\"Note\" EntityType=\"SE" +
                "DModel.Note\" /><EntitySet Name=\"Student\" EntityType=\"SEDModel.Student\" /><Associ" +
                "ationSet Name=\"FK__Note__student_id__38996AB5\" Association=\"SEDModel.FK__Note__s" +
                "tudent_id__38996AB5\"><End Role=\"Note\" EntitySet=\"Note\" /><End Role=\"Student\" Ent" +
                "itySet=\"Student\" /></AssociationSet></EntityContainer></Schema></edmx:DataServic" +
                "es></edmx:Edmx>";
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Services.Design", "1.0.0")]
    ...
    /// <summary>
    /// There are no comments for SEDModel.Note in the schema.
    /// </summary>
    /// <KeyProperties>
    /// id
    /// </KeyProperties>
    ...
    /// <summary>
    /// There are no comments for SEDModel.Student in the schema.
    /// </summary>
    /// <KeyProperties>
    /// id
    /// </KeyProperties>
