...
namespace MVC
{
    public class WcfDataService1 : EntityFrameworkDataService<SEDEntities>
    {
        public static void InitializeService(DataServiceConfiguration config)
        {
            config.SetEntitySetAccessRule("*", EntitySetRights.All); //для всех сущностных множеств разрешены все операции
